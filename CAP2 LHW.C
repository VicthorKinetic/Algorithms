...
3 - Escreva um programa que receba dados via teclado para variaveiS do tipo short,
    long, unsigned, float, double e um char e imprima-os no video.

4 - Usando os operadores aritmeticos soma "+", subtracao "-" e multiplicacao "*"
...
5 - Reescreva o exercicio anterior recebendo via teclado 2 numeros reais em
